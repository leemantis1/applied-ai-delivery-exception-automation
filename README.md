...
This project demonstrates a proof of concept multi-agent workflow that automates last-mile delivery exception handling using n8n, tool-calling agents, retrieval-augmented generation, deterministic escalation rules, critic validation, and an evaluation harness.
...
This project demonstrates practical AI program delivery by connecting business problem framing, workflow architecture, agentic AI design, operational rules, security considerations, and measurable evaluation outcomes.
